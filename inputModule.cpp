...
static int startX;
static int startY;
static GLfloat angle1 = 20; /* in degrees */
static GLfloat angle2 = 30;   /* in degrees */

GLfloat current_pos[] = {0.0, 0.0, 5.0};

//added these for moving light calculations
...
void readKeyboard(unsigned char key, int x, int y)
{
  ...
  case 'T':
        ...
        {
           movingLight = false;
           std::cout << "Moving Viewpoint" << std::endl;
        }
        else
        {
            movingLight = true;
            std::cout << "Moving Light" << std::endl;
        }
		break;
  case 'r':
  case 'R': 
   // reset initial view parameters
    ...
    //reset initial light parameters
    lightAngle1 = 20;
    lightAngle2 = 30;
...
void setLightView()
{
    ...
    glRotated(lightAngle1, 1.0, 0.0, 0.0);
    glRotated(lightAngle2, 0.0, 1.0, 0.0);
}
